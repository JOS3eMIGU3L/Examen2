 ...
 * Ejercicios
 */
public class ResoluciónExamenJMHP {

    static Scanner leerT=new Scanner(System.in);
    public static void ImpuestoDELOScarros() {
        //Declarar variables
        ...
        while (hayMas.equals("S")) {
            ...
            clavedecategoría=leerT.next().toUpperCase();
            if (clavedecategoría.equals("1")) {
                System.out.println("Ingrese la cantidad de Vehículos de categoría "+clavedecategoría+":");
                cantcategoría1=cantcategoría1+leerT.nextInt();
                if (preciocategoría1==0){
                System.out.println("Ingrese el precio del Vehículo de categoría "+clavedecategoría+":");
                preciocategoría1=leerT.nextDouble();
                }
                ...
                cantcategoría2= cantcategoría2+leerT.nextInt();
                if (preciocategoría2==0){
                System.out.println("Ingrese el precio del Vehículo de categoría "+clavedecategoría+":");
                preciocategoría2=leerT.nextDouble();
                }
                impcategoría2=preciocategoría2*0.08;
            }else if (clavedecategoría.equals("3")){
                System.out.println("Ingrese la cantidad de de Vehículos de categoría "+clavedecategoría+":");
                cantcategoría3=cantcategoría3+leerT.nextInt();
                if (preciocategoría3==0){
                System.out.println("Ingrese el precio del Vehículo de categoría "+clavedecategoría+":");
                preciocategoría3=leerT.nextDouble();
                }
